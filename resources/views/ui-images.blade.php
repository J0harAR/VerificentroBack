        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <img class="rounded me-2" alt="200x200" width="200" src="build/images/small/img-4.jpg"
                        ...
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="img-thumbnail rounded-circle avatar-xl" alt="200x200"
                                    src="build/images/users/avatar-3.jpg" data-holder-rendered="true">
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                </div><!-- end card-body -->
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                            <img class="rounded avatar-md" src="build/images/users/avatar-3.jpg"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 me-3">
                            <img class="rounded avatar-md" src="build/images/users/avatar-5.jpg"
                                alt="Generic placeholder image">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-end">
                        <div class="flex-shrink-0 me-3">
                            <img class="rounded avatar-md" src="build/images/users/avatar-1.jpg"
                                alt="Generic placeholder image">
                        </div>
                        <div class="flex-grow-1">

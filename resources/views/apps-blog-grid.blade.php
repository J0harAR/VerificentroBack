...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h5 class="card-title">Blog Grid <span class="text-muted fw-normal ms-2">(535)</span></h5>
        </div>
    </div>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
            <div>
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link" href="apps-blog-list.html" data-bs-toggle="tooltip" data-bs-placement="top" title="List"><i class="bx bx-list-ul"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="apps-blog-grid.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Grid"><i class="bx bx-grid-alt"></i></a>
                    </li>
                </ul>
            </div>
            <div>
...
<div class="row">
    ...
    <div class="col-xl-4 col-sm-6">
        <div class="card">
            <div class="">
                <img src="build/images/small/img-2.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-4 col-sm-6">
        <div class="card">
            <div class="">
                <img src="build/images/small/img-4.jpg" alt="" class="img-fluid">
            </div>
            <div class="card-body">

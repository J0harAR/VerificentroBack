                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img online align-self-center me-3">
                                                <img src="build/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt="">
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            <div class="flex-shrink-0 user-img away align-self-center me-3">
                                                <img src="build/images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="build/images/users/avatar-4.jpg" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="build/images/users/avatar-5.jpg" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="build/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                    ...
                                    <ul class="list-inline message-img mt-3  mb-0">
                                        <li class="list-inline-item message-img-list">
                                            <a class="d-inline-block m-1" href="">
                                                <img src="build/images/small/img-1.jpg" alt="" class="rounded img-thumbnail">
                                            </a>
                                        </li>

                                        <li class="list-inline-item message-img-list">
                                            <a class="d-inline-block m-1" href="">
                                                <img src="build/images/small/img-2.jpg" alt="" class="rounded img-thumbnail">
                                            </a>
                                        </li>
                                    </ul>
                                </div>

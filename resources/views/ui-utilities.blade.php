...
<div class="row">
        ...
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-3 align-items-center">
                    <img src="build/images/users/avatar-10.jpg" class="rounded avatar-xl" alt=" ">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-top avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-end avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-bottom avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-start avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-circle avatar-xl" alt="">
                    <img src="build/images/small/img-3.jpg" alt="" class="rounded-pill w-25 h-auto">
                </div>
            </div>
        </div>
    </div><!-- end col -->
    <div class="col-xl-4">
        <div class="card card-h-100">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap gap-2">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-0 avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-1 avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-2 avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-3 avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-4 avatar-xl" alt="">
                    <img src="build/images/users/avatar-10.jpg" class="rounded-5 avatar-xl" alt="">
                </div>
            </div><!-- end cardbody -->
        </div><!-- end card -->
    </div><!-- end col -->
